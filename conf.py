...
project = 'Petlja - Настава програмирања за Други разред гимназије'
...
html_context = {'course_id': 'Настава програмирања за Други разред гимназије',
                ...
                'basecourse': 'Настава програмирања за Други разред гимназије',
...
html_theme_options = {
    ...
    'navbar_title': "Petlja - Настава програмирања за Други разред гимназије",
...
html_title = 'Petlja - Настава програмирања за Други разред гимназије'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Petlja - Настава програмирања за Други разред гимназије'
...
htmlhelp_basename = 'Настава програмирања за Други разред гимназије-doc'
